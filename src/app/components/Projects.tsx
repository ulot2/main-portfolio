  ...
  return (
    <section id="projects" className="bg-black py-24 px-6 sm:px-12">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 auto-rows-[250px] gap-4 md:grid-cols-4 md:auto-rows-[300px]">
          {featuredProjects.map((project, index) => {
            ...
            return (
              <Link
                ...
                className={`group relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 transition-all duration-300 hover:border-white/20 hover:shadow-2xl hover:shadow-blue-500/10 ${config.className}`}
              >
